...
# ── Logo / Header ──────────────────────────────────────────────────────────────
def add_logo():
    """Add Wells Fargo red header bar with logo and app title"""
    import base64
    ...
    try:
        ...
        try:
            ...
            pass  # No logo file found — header renders without image
    ...
    ">
        ...
        <span style="
            ...
            padding-left: 15px;
            margin-left: {'10px' if logo_html else '0px'};
            font-family: 'Inter', sans-serif;
            letter-spacing: 0.02em;
        ">⚡ Execution Agent &nbsp;·&nbsp; Performance Testing Platform</span>
    </div>
